...
export default function FeatureCards() {
  return (
    <section className="bg-slate-50 dark:bg-slate-900">
      <div className="container space-y-8 py-12 text-center lg:py-40">
        ...
        <div className="grid grid-cols-1 place-items-center gap-48 py-20 md:grid-cols-1">
          {featuredCategory.content.map((cards, index) => {
            ...
            return (
              <Card
                key={cards.text}
                className={`group relative flex h-64 w-[90vw] items-center justify-between overflow-visible rounded-xl border-none p-8 shadow-sm transition-all duration-200 hover:bg-pink-100 hover:shadow-lg dark:bg-secondary ${
